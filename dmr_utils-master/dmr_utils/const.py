...
# Slot Type Data types - Converted to bytes for Py3
DMR_SLT_VHEAD = b'\x01'
DMR_SLT_VTERM = b'\x02'
...
# LC Options - Use for Group Voice - Converted to bytes for Py3
...
if __name__ == '__main__':
    ...
    pprint(EMB)
    pprint(SLOT_TYPE)
    # Corrected for Py3 bytes output
    print(ahex(LC_OPT).decode('ascii'))