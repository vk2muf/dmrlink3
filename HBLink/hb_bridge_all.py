...
class bridgeallSYSTEM(HBSYSTEM):
    ...
    def __init__(self, _name, _config, _logger):
        ...
        # Note: In Python 3, using bytes (b'\x00') for clarity
        self.STATUS = {
            1: {
                'RX_START':     time(),
                'RX_SEQ':       b'\x00',
    ...
    def dmrd_received(self, _radio_id, _rf_src, _dst_id, _seq, _slot, _call_type, _frame_type, _dtype_vseq, _stream_id, _data):
        ...
        # In Python 3, _data[15] is already an integer
        _bits = _data[15]
        ...
        if _call_type == 'group':
            ...
            if (_stream_id != self.STATUS[_slot]['RX_STREAM_ID']):
                self.STATUS[_slot]['RX_START'] = pkt_time # Added missing slot index to RX_START
